...
/**
 * @param specSuite must be a path to a file that, when required, exports an object that satisfies
 *   the contract of JasmineEnv.
...
export function runSpecSuite (
  ...
  let jasmineEnv: JasmineEnv = require(specSuite)
